 ...
 */
final class Version20220411083835 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE agencylove CHANGE idAgency idAgency INT NOT NULL, CHANGE idUser idUser INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE book CHANGE idUser idUser INT NOT NULL, CHANGE idHotel idHotel INT NOT NULL, CHANGE idRoom idRoom INT NOT NULL, CHANGE idHotelChain idHotelChain INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE comment CHANGE nblike nblike INT DEFAULT 0, CHANGE nbdislike nbdislike INT DEFAULT 0 NOT NULL, CHANGE subject_Id subject_Id INT NOT NULL, CHANGE User_Id User_Id INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE dislikee CHANGE commentId commentId INT NOT NULL, CHANGE userID userID INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE likee CHANGE commentId commentId INT NOT NULL, CHANGE userID userID INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE rent CHANGE idAgency idAgency INT NOT NULL, CHANGE idUser idUser INT NOT NULL, CHANGE idCar idCar INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE subject CHANGE acceptsubject acceptsubject INT DEFAULT 0 NOT NULL, CHANGE hidesubject hidesubject INT DEFAULT 0 NOT NULL, CHANGE topic_Id topic_Id INT NOT NULL, CHANGE User_Id User_Id INT NOT NULL');
