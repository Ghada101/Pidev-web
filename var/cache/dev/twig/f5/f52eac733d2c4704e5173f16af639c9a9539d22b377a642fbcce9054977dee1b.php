...
class __TwigTemplate_12400292d80585736bce1de59d43a867d20d39cf175604b94981e01e184fcbac extends Template
{
    private $source;
    private $macros = [];
...
<script>
    function greeting() {
        let searchlinput = document.getElementById(\"searchinput\")
        const searchValue = searchlinput.value; 
        console.log('searchValue',searchValue);
        \$.ajax({
            type: \"POST\", 
            url: \"";
        // line 548
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("demo_create");
        echo "\",
            data:{ search: searchValue, path:'ajax' },
            success: function (msg) {
                const content = document.querySelector(\"#commandeSection\");
...
";
    ...
    {
        return array (  776 => 433,  766 => 432,  754 => 564,  737 => 548,  714 => 528,  710 => 527,  706 => 526,  702 => 525,  698 => 524,  694 => 523,  689 => 521,  684 => 519,  680 => 518,  676 => 517,  672 => 516,  668 => 515,  664 => 514,  660 => 513,  656 => 512,  652 => 511,  648 => 510,  644 => 509,  640 => 508,  636 => 507,  632 => 506,  628 => 505,  624 => 504,  620 => 503,  616 => 502,  612 => 501,  608 => 500,  604 => 499,  600 => 498,  596 => 497,  590 => 494,  584 => 491,  578 => 488,  572 => 485,  568 => 484,  559 => 477,  516 => 434,  514 => 432,  510 => 430,  499 => 416,  466 => 352,  451 => 340,  436 => 328,  246 => 141,  210 => 108,  206 => 107,  202 => 106,  143 => 50,  127 => 37,  123 => 36,  119 => 35,  115 => 34,  111 => 33,  107 => 32,  103 => 31,  99 => 30,  95 => 29,  91 => 28,  87 => 27,  83 => 26,  79 => 25,  73 => 22,  69 => 21,  60 => 15,  44 => 1,);
    }
    ...
    <ul class=\"navbar-nav bg-gradient-primary sidebar sidebar-dark accordion\" id=\"accordionSidebar\">
        ...
        <li class=\"nav-item\">
            ...
            <div id=\"collapseHotel\" class=\"collapse\" aria-labelledby=\"headingTwo\" data-parent=\"#accordionSidebar\">
                <div class=\"bg-white py-2 collapse-inner rounded\">
                    <h6 class=\"collapse-header\">Hotel:</h6>
                    <a class=\"collapse-item\" href=\"{{ path('app_hotelchain_index')}}\">HotelChains</a>
                    <a class=\"collapse-item\" href=\"{{ path('app_hotel_index')}}\">Hotel</a>
                    <a class=\"collapse-item\" href=\"{{ path('app_room_index')}}\">Room</a>
                </div>
            </div>
        </li>
        <!-- Nav Item - End Hotel Management-->
    ...
    <div id=\"content-wrapper\" class=\"d-flex flex-column\">
        ...
        <div id=\"content\">
                   ...
                   {#  {% if app.user %}
                        ...
                        <li class=\"nav-item dropdown no-arrow\">
                            ...
                            <div class=\"dropdown-menu dropdown-menu-right shadow animated--grow-in\"
                                ...
                                <a class=\"dropdown-item\" href=\"{{ path('profil') }}\">
           ...
           {#  <div class=\"d-sm-flex align-items-center justify-content-between mb-4\">
                    ...
                    <a href=\"{{ path('app_pdf') }}\" class=\"d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm\"><i
...
</html>", "backOffice/baseBack.html.twig", "C:\\laragon\\www\\ALLINTRAVELFINALWEB\\templates\\Backoffice\\baseback.html.twig");
    }
}
