...
class CategoryRepository extends ServiceEntityRepository
{
    ...
    public function find_Nb_Restau_Per_Category($nameCategory)
    {
        $em = $this->getEntityManager();
        
       /* $query = $em->createQuery(
            'SELECT DISTINCT  count(c.idcategory) FROM   App\Entity\Category c  where c.nameCategory = :nameCategory   ' );
