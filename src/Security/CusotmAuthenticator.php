...
class CusotmAuthenticator extends AbstractFormLoginAuthenticator implements PasswordAuthenticatedInterface
{
    use TargetPathTrait;
...
//            $this->addFlash('message','You have been banned, please contact the administrator');
