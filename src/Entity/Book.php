 ...
 * Book
 *
 * @ORM\Table(name="book", indexes={@ORM\Index(name="fkUser", columns={"idUser"}), @ORM\Index(name="fkHotel", columns={"idHotel"}), @ORM\Index(name="fkRoom", columns={"idRoom"}), @ORM\Index(name="fkHotelChain", columns={"idHotelChain"})})
 * @ORM\Entity
 */
class Book
{
