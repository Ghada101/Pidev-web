 ...
 * Reservetable
 *
 * @ORM\Table(name="reservetable", indexes={@ORM\Index(name="userfk", columns={"idUser"}), @ORM\Index(name="fkCategory", columns={"IdCategory"}), @ORM\Index(name="fk_Restau", columns={"id_Restau"}), @ORM\Index(name="fk_Table", columns={"id_Table"})})
 * @ORM\Entity
 */
class Reservetable
{
