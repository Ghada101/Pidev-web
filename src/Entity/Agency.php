...
class Agency
{
     ...
     * @var string|null
     *
     * @ORM\Column(name="imageAgency", type="string", length=255, nullable=true, options={"default"="NULL"})
     */
    private $imageagency = 'NULL';

    /**
     * @var int|null
     *
     * @ORM\Column(name="nbrLike", type="integer", nullable=true, options={"default"="NULL"})
     */
    private $nbrlike = NULL;
